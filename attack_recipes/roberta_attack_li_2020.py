...
from textattack.transformations import WordSwapMaskedLM_roberta


def RoBERTaAttackLi2020(model):
    ...
    transformation = WordSwapMaskedLM_roberta(method="roberta-attack", max_candidates=48)
    #
