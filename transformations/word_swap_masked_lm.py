...
class WordSwapMaskedLM(WordSwap):
    ...
    def _bert_sa_replacement_words(self, current_text, index):
        """Get replacement words for the word we want to replace using Bert-SA
        method.
    ...
    def _get_replacement_words(self, current_text, index, **kwargs):
        ...
        elif self.method == "bert-sa":
            return self._bert_sa_replacement_words(current_text, index)
        else:
